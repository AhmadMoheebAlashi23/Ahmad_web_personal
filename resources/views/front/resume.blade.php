                                    ...
                                    <div class="row align-items-center gx-5">
                                        <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                            <div class="bg-light p-4 rounded-4">
                                                ...
                                                <div class="small text-muted">{{ $experience->loaction }}</div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        @foreach ($skills as $skill )
                                            <div class="col mb-4 mb-md-0"><div class="d-flex align-items-center bg-light rounded-4 p-3 h-100">{{ $skill->title }}</div></div>
                                        @endforeach
                                    ...
                                    <div class="mb-0">
                                        ...
                                        @foreach ($languages as $language )
                                            <div class="col mb-4 mb-md-0"><div class="d-flex align-items-center bg-light rounded-4 p-3 h-100">{{ $language->title }}</div></div>
                                            {{-- <div class="d-flex align-items-center bg-light rounded-4 p-3 mb-3">{{ $language->title }}</div> --}}
                                        @endforeach
                                        </div>
