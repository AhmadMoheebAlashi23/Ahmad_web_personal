<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Educations') }}
        </h2>
                <a class="btn btn-primary text-white"  href="{{ route('educations.index') }}">ALL Educations </a>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('educations.store') }}" method="POST">
                     ...
                     <div class="mt-4">
                         ...
                         <x-textarea id="description" class="block mt-1 w-full" type="text" name="description"  required autofocus autocomplete="description" >{{ old('description') }}</x-textarea>
