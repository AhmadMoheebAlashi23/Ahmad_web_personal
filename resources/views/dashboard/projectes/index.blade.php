<x-app-layout>
    <x-slot name="header">
        ...
        <a class="btn btn-primary text-white"  href="{{ route('projects.create') }}">Create new Projects </a>
                    ...
                    <tbody>
                        ...
                        @foreach($projects as $project)
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <a class="btn btn-primary text-white" href="{{ route('projects.edit', $project->id) }}" role="button" >Edit</a>
