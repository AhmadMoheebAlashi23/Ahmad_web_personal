    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Language') }}
                ...
                <a class="btn btn-primary text-white"  href="{{ route('languages.index') }}">ALL skills </a>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('languages.update',$language->id) }}" method="POST">
                     ...
                     <div>
                         ...
                         <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title',$language->title)" required autofocus autocomplete="title" />
